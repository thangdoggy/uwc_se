...
import { mcpsData, mcpUncollect } from "../data/mcps";
  ...
  return (
    <div className="ml-64 pt-28">
      ...
      <div>
        <div>
          {popup1 && (
            <Popup // add mcps pop-up
              content={
                <AddNew1
                  infoToAdd={infoToAdd}
                  setInfoToAdd={setInfoToAdd}
          ...
          {viewPopup && (
            <Popup
              content={
                <ViewMCP
                  mcpID={clickedMCPID}
                  toggleViewPopup={toggleViewPopup}
        ...
        <button
          ...
          onClick={() => {
            if (infoToAdd.address === "") {
              ...
              infoToAdd.currentVolume < 0 ||
              infoToAdd.currentVolume > 100
            ) {
...
const ViewMCP = (props) => {
  ...
  return (
    <>
      ...
      <p>
        <b>Địa chỉ:</b> {mcp.address}
      </p>
      <p>
        <b>Khối lượng hiện tại:</b> {mcp.currentVolume} (%)
      </p>
      <p>
        <b>Sức chứa tối đa:</b> {mcp.capacity} (tấn)
      </p>
      <p>
        <b>Người thu gom:</b>
      </p>
        ...
        <button
          ...
          onClick={() => {
            if (userInfo.address === "") {
              ...
              userInfo.currentVolume < 0 ||
              userInfo.currentVolume > 100
            ) {
              alert("Current volume has to be in range of 0 to 100");
